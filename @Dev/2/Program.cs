...
class Program
{
    static void Main(string[] args)
    {
        ...
        var userDemand = new List<string> {
            "Water", "Bread", "Egg", "Battery", "ChessBurger",
            "Fuel", "Burger" 
        };
        ...
        var solution2 = Exhaustive_Method(map, userDemand);
    ...
    static Recommend_Aquire_Commodities_Path Exhaustive_Method(Map map, List<string> aquireList)
    {
